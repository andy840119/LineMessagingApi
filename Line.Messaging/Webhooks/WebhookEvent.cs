        ...
        internal static WebhookEvent CreateFrom(dynamic dynamicObject)
        {
            ...
            switch (eventType)
            {
                ...
                case WebhookEventType.Follow:
                    return new FollowEvent(eventSource, (long) dynamicObject.timestamp,
                        (string) dynamicObject.replyToken);
                ...
                case WebhookEventType.Join:
                    return new JoinEvent(eventSource, (long) dynamicObject.timestamp,
                        (string) dynamicObject.replyToken);
                ...
                case WebhookEventType.Postback:
                    ...
                    return new PostbackEvent(eventSource, (long) dynamicObject.timestamp,
                        (string) dynamicObject.replyToken, postback);
                case WebhookEventType.Beacon:
                    if (!Enum.TryParse((string) dynamicObject.beacon.type, true, out BeaconType beaconType))
                        return null;

                    return new BeaconEvent(eventSource, (long) dynamicObject.timestamp,
                        (string) dynamicObject.replyToken,
                ...
                case WebhookEventType.AccountLink:
                    ...
                    return new AccountLinkEvent(eventSource, (long) dynamicObject.timestamp,
                        (string) dynamicObject.replyToken, link);
                case WebhookEventType.Things:
                    var thingsType =
                        (ThingsType) Enum.Parse(typeof(ThingsType), (string) dynamicObject.things?.type, true);
                ...
                case WebhookEventType.MemberJoined:
                    ...
                    return new MemberJoinEvent(eventSource, (long) dynamicObject.timestamp,
                        (string) dynamicObject.replyToken, joinedMembers);
